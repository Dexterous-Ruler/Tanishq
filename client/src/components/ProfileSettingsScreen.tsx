...
export const ProfileSettingsScreen = ({
  ...
  return (
    <div className="min-h-screen bg-white w-full max-w-[390px] mx-auto" data-testid="profile-settings-screen">
      <motion.div initial="hidden" animate="visible" variants={containerVariants} className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto pb-6">
          ...
          <motion.div variants={itemVariants} className="mx-4 mt-6 mb-4">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100" data-testid="profile-header">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-2xl font-bold shadow-lg" data-testid="avatar-initials">
                    {getInitials(userName)}
                  </div>
                  <div>
                    <h2 className="text-xl font-bold text-gray-900" data-testid="text-user-name">{userName}</h2>
                    <div className="flex items-center mt-1 space-x-2">
                      <span className="text-sm text-gray-600">ABHA ID:</span>
                      <span className="text-sm font-medium text-gray-800" data-testid="text-abha-id">{abhaId}</span>
                    </div>
              ...
              <div className="p-4 border-b border-gray-100">
                ...
                <div className="flex space-x-2">
                  <button 
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${selectedLanguage === 'english' ? 'bg-purple-600 text-white shadow-lg shadow-purple-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                  ...
                  <button 
                    ...
                    className={`flex-1 py-2.5 px-4 rounded-lg font-medium text-sm transition-all ${selectedLanguage === 'hindi' ? 'bg-purple-600 text-white shadow-lg shadow-purple-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${guidedMode ? 'bg-green-600' : 'bg-gray-300'}`} 
                    role="switch" 
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <button 
                    ...
                    className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${biometric ? 'bg-green-600' : 'bg-gray-300'}`} 
                    role="switch" 
          ...
          <motion.div variants={itemVariants} className="mx-4 mb-6">
            <button 
              onClick={onLogout} 
              className="w-full py-4 px-6 bg-white border-2 border-red-500 text-red-600 rounded-2xl font-semibold hover:bg-red-50 transition-colors flex items-center justify-center space-x-2 shadow-sm"
